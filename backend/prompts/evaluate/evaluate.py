# TODO for the evaluation, add the index of the sections document to the evaluation.
...
# Define data models (keeping existing models)
...
def evaluate_section(
    ...
    # Add sentence-level content to the section
    if section["content"]:
...
def process_article_sections(
    ...
    return evaluation, requirements, sections
...
if __name__ == "__main__":
    ...
    e, r, s = process_article_sections(markdown_content, requirements)

    # Save the final JSON to a file
    with open("evaluation-output.json", "w") as outfile:
        json.dump(e.model_dump(), outfile, indent=4)
